...
print('Menampilkan data dari bagian depan ke belakang: ', end = ' ')
dll.display_forward()  #Output: 5 10 20 30 
print('Menampilkan data dari bagian belakang ke depan: ', end = ' ')
...
dll.delete_from_end()
print()
print('Menampilkan data linked list setekah delete data: ', end = ' ')
